...
function Content() {
    return (
        <div id="content">
            ...
            and datatype of which dataset is to be built. And the result is a zip file containing the built dataset. </p>
            ...
            <h3>Milestone 4 - Tesdting tje module</h3>
            <p>4th phase
            ...
            By this part we have our bidsdatabuilder and bidsDIrwarcher ready and tested
